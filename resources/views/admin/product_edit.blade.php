        ...
        <div class="main-content-wrap">
            ...
            <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{ route('admin.product.update') }}">
                ...
                <div class="wg-box">
                    ...
                    @error('name') <span class="alert alert-danger tex-center">{{$message}}</span> @enderror
                    ...
                    @error('slug') <span class="alert alert-danger tex-center">{{$message}}</span> @enderror
                    ...
                    <div class="gap22 cols">
                        <fieldset class="category">
                         ...
                         @error('category_id') <span class="alert alert-danger tex-center">{{$message}}</span> @enderror
                        ...
                        @error('brand_id') <span class="alert alert-danger tex-center">{{$message}}</span> @enderror
                    </div>
                    ...
                    <fieldset class="shortdescription">
                        ...
                        <div class="text-tiny">Do not exceed 100 characters when entering theproduct name.</div>
                    </fieldset>
                    @error('short_description') <span class="alert alert-danger tex-center">{{$message}}</span> @enderror
                    ...
                    <fieldset class="description">
                     ...
                     @error('description') <span class="alert alert-danger tex-center">{{$message}}</span> @enderror
                ...
                <div class="wg-box">
                            ...
                            <div class="item" id="imgpreview">
                                @if ($product->image)
                                    <img src="{{ asset('uploads/products/thumbnails') }}/{{ $product->image }}"
                                        alt="{{ $product->name }}" class="effect8">
                    ...
                    <fieldset>
                     ...
                     @error('images') <span class="alert alert-danger tex-center">{{$message}}</span> @enderror
                    ...
                    <div class="cols gap22">
                       ...
                       @error('regular_price') <span class="alert alert-danger tex-center">{{$message}}</span> @enderror
                        ...
                        @error('sale_price') <span class="alert alert-danger tex-center">{{$message}}</span> @enderror
                    </div>
                    ...
                    <div class="cols gap22">
                        ...
                        @error('SKU') <span class="alert alert-danger tex-center">{{$message}}</span> @enderror
                    </div>
                        <fieldset class="name">
                        ...
                        @error('quantity') <span class="alert alert-danger tex-center">{{$message}}</span> @enderror
                    </div>
                    </div>
                    ...
                    <div class="cols gap22">
                        ...
                        @error('stock_status') <span class="alert alert-danger tex-center">{{$message}}</span> @enderror
                    </div>
                        <fieldset class="name">
                        ...
                        @error('featured') <span class="alert alert-danger tex-center">{{$message}}</span> @enderror
                    </div>
