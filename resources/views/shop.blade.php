        ...
        <div class="accordion" id="categories-list">
          <div class="accordion-item mb-4 pb-3">
            ...
            <div id="accordion-filter-1" class="accordion-collapse collapse show border-0"
              ...
              <div class="accordion-body px-0 pb-0 pt-3" style=" line-height: 40px;">
                <ul class="list list-inline mb-0">
                    @foreach($categories as $category)
                      <li class="list-item">
                          <span class="menu-item py-1">
      ...
      <div class="shop-list flex-grow-1">
        ...
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          ...
          <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
             <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Page Size" id="pagesize" style="margin-right: 20px;" name="pagesize">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            @foreach (explode(",",$product->images) as $gimg )
                                <a href="{{ route('shop.product.details', ['product_slug'=>$product->slug]) }}"><img loading="lazy" src="{{ asset('uploads/products')}}/{{ $gimg}}" width="330" height="400" alt="{{ $product->name }}" class="pc__img">
                                </a>
                            @endforeach
